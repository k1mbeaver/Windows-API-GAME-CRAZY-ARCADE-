...
void Mark::Initialize(HDC hdc)
{
	...
	hbitmap = (HBITMAP)LoadImage(NULL, L"C:\\Users\\USER\\Desktop\\연구실 공부\\허승찬 선배님 스터디\\크레이지 아케이드\\Crazy Arcade\\Crazy Arcade\\Image\\player\\solo_player.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
